...
import com.twitter.finagle.smtp.extension.auth.{AuthRejected, AuthRequired, AuthSuccessful, ServerChallenge}
...
object Reply {
  /**
   * Specifies an [[com.twitter.finagle.smtp.UnspecifiedReply]]
   */
