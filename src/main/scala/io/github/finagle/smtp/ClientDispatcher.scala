...
import io.github.finagle.smtp.extension.pipelining.GroupPart
...
class ClientDispatcher(trans: Transport[Request, UnspecifiedReply])
   ...
   * [[io.github.finagle.smtp.NonTerminalLine]]. Once
   ...
   * If their codes are not matching, an [[io.github.finagle.smtp.InvalidReply]]
   * is returned.
   */
