...
import io.github.finagle.smtp.extension.auth.{AuthRejected, AuthRequired, AuthSuccessful, ServerChallenge}
...
trait UnspecifiedReply {
 ...
 /**
  * Gets a sequence containing reply lines
...
/**
 * A non-terminal part of multiline reply.
 */
case class NonTerminalLine(code: Int, info: String) extends UnspecifiedReply

/**
 * Contains all standard SMTP reply codes.
 */
object ReplyCode {
...
import io.github.finagle.smtp.ReplyCode._
import io.github.finagle.smtp.extension.auth.AuthReplyCode._

object Reply {
  /**
   * Specifies an [[io.github.finagle.smtp.UnspecifiedReply]]
   */
