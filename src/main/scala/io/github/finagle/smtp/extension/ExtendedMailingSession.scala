...
import io.github.finagle.smtp.{MailingAddress, TextRequest}
...
case class ExtendedMailingSession(sender: MailingAddress, ext: Map[String, String] = Map.empty)
   ...
   * [[io.github.finagle.smtp.extension.auth.AuthRequest]]
   ...
   * [[io.github.finagle.smtp.extension.auth.AuthRequest]] first.
   */
